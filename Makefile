...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/11/09 19:34:34 by hchadili          #+#    #+#              #
#    Updated: 2023/11/12 20:54:57 by hchadili         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c \
		...
		ft_memcmp.c ft_strnstr.c ft_atoi.c ft_strdup.c ft_calloc.c ft_strjoin.c ft_substr.c ft_strtrim.c \
